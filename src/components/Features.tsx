      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Por que escolher a HR?
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            HR é o ponto alto do seu negócio, onde a inteligência artificial e a automação transformam a sua operação,
            otimizando resultados e levando a sua empresa ao próximo nível.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            title="Equipe Mais Focada"
            description="Libere seus vendedores de tarefas repetitivas e permita que foquem no fechamento de negócios."
            index={0}
          />
          <FeatureCard
            ...
            title="Atendente 24/7"
            description="Sua equipe ganha uma atendente extra que nunca dorme e não perde um contato."
            index={1}
          />
          <FeatureCard
            ...
            description="Seu negócio atende mais clientes sem a necessidade de aumentar a sua equipe de forma manual."
            index={2}
          />
          <FeatureCard
            ...
            title="Suporte Total"
            description="Um time dedicado para manter seus sistemas seguros e operando perfeitamente."
            index={3}
          />
          <FeatureCard
            ...
            description="Acabe com a perda de clientes por demora na resposta e no atendimento."
            index={4}
          />
          <FeatureCard
            ...
            title="Mais Lucro"
            description="O aumento de contatos e a agilidade no atendimento elevam seus resultados."
            index={5}
          />
        </div>
      </div>
